...
1. Vamos a ver qué es un Bag of Words
2. Algunas herramientas de normalización de datos
3. Veremos cómo calcular distancia de palabras y documentos
...
![https://www.pnas.org/content/pnas/115/16/E3635.full.pdf](img/embeddings_stereotypes.png)

![https://dl.acm.org/citation.cfm?id=2390490](img/elections.png)

![https://link.springer.com/article/10.1007/s11199-019-01019-x](img/films.png)
