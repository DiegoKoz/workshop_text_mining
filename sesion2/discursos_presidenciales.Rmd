...
stop_words <- unique(stri_trans_general(stopwords(kind = "es"), "Latin-ASCII")) # le tengo que hacer la misma transformacion que al texto

Corpus = tm_map(Corpus, removeWords, c(stop_words,palabras_comunes))
